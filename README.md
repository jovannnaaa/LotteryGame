Проект по Визуелно Програмирање (LOTTERY GAME)
...
GameForm:
Ова е главната форма каде што се главниот дел од играта.Овде играчот ги бира своите 7 среќни броеви и во зависност од изборот на режим продолжува напред или ги добива своите резултати.
